...
function Projects() {
  ...
  const projects = [
      ...
      },
    {
      name: "GrowthPilot",
      emoji: "⚡",
      subtitle: "SAAS AI Business Analyzer",
      stack: ["React.js", "Framer", "JavaScript", "Chart.js"],
      highlights: [
        "AI-powered SaaS analytics platform delivering forecasting and anomaly detection",
        "Graph view for every insights",
        "Designed 6 intelligent dashboard modules, increasing data visibility and user engagement by 35%",
      ],
      links: { github: "https://github.com/Om-Thote/GrowthPilot" },
      color: "#C73D4C",
      span: 7,
    },
  ];
